...
import { Animated, Easing, I18nManager,TouchableWithoutFeedback, ViewStyle } from "react-native"
...
const WIDTH = 56
const MARGIN = 2
const OFF_POSITION = I18nManager.isRTL ? -(WIDTH - THUMB_SIZE) :  -0.5
const ON_POSITION = I18nManager.isRTL ? 0 : WIDTH - THUMB_SIZE - MARGIN
